 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var K_;function mS(){return K_||(K_=1,function(o){function e(I,Z){var j=I.length;I.push(Z);e:for(;0<j;){var Ee=j-1>>>1,U=I[Ee];if(0<r(U,Z))I[Ee]=Z,I[j]=U,j=Ee;else break e}}function n(I){return I.length===0?null:I[0]}function a(I){if(I.length===0)return null;var Z=I[0],j=I.pop();if(j!==Z){I[0]=j;e:for(var Ee=0,U=I.length,ee=U>>>1;Ee<ee;){var xe=2*(Ee+1)-1,Se=I[xe],J=xe+1,pe=I[J];if(0>r(Se,j))J<U&&0>r(pe,Se)?(I[Ee]=pe,I[J]=j,Ee=J):(I[Ee]=Se,I[xe]=j,Ee=xe);else if(J<U&&0>r(pe,j))I[Ee]=pe,I[J]=j,Ee=J;else break e}}return Z}function r(I,Z){var j=I.sortIndex-Z.sortIndex;return j!==0?j:I.id-Z.id}if(o.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;o.unstable_now=function(){return c.now()}}else{var u=Date,h=u.now();o.unstable_now=function(){return u.now()-h}}var d=[],p=[],g=1,_=null,v=3,y=!1,E=!1,T=!1,S=!1,x=typeof setTimeout=="function"?setTimeout:null,O=typeof clearTimeout=="function"?clearTimeout:null,N=typeof setImmediate<"u"?setImmediate:null;function C(I){for(var Z=n(p);Z!==null;){if(Z.callback===null)a(p);else if(Z.startTime<=I)a(p),Z.sortIndex=Z.expirationTime,e(d,Z);else break;Z=n(p)}}function F(I){if(T=!1,C(I),!E)if(n(d)!==null)E=!0,H||(H=!0,le());else{var Z=n(p);Z!==null&&de(F,Z.startTime-I)}}var H=!1,B=-1,X=5,D=-1;function w(){return S?!0:!(o.unstable_now()-D<X)}function V(){if(S=!1,H){var I=o.unstable_now();D=I;var Z=!0;try{e:{E=!1,T&&(T=!1,O(B),B=-1),y=!0;var j=v;try{t:{for(C(I),_=n(d);_!==null&&!(_.expirationTime>I&&w());){var Ee=_.callback;if(typeof Ee=="function"){_.callback=null,v=_.priorityLevel;var U=Ee(_.expirationTime<=I);if(I=o.unstable_now(),typeof U=="function"){_.callback=U,C(I),Z=!0;break t}_===n(d)&&a(d),C(I)}else a(d);_=n(d)}if(_!==null)Z=!0;else{var ee=n(p);ee!==null&&de(F,ee.startTime-I),Z=!1}}break e}finally{_=null,v=j,y=!1}Z=void 0}}finally{Z?le():H=!1}}}var le;if(typeof N=="function")le=function(){N(V)};else if(typeof MessageChannel<"u"){var re=new MessageChannel,_e=re.port2;re.port1.onmessage=V,le=function(){_e.postMessage(null)}}else le=function(){x(V,0)};function de(I,Z){B=x(function(){I(o.unstable_now())},Z)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(I){I.callback=null},o.unstable_forceFrameRate=function(I){0>I||125<I?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):X=0<I?Math.floor(1e3/I):5},o.unstable_getCurrentPriorityLevel=function(){return v},o.unstable_next=function(I){switch(v){case 1:case 2:case 3:var Z=3;break;default:Z=v}var j=v;v=Z;try{return I()}finally{v=j}},o.unstable_requestPaint=function(){S=!0},o.unstable_runWithPriority=function(I,Z){switch(I){case 1:case 2:case 3:case 4:case 5:break;default:I=3}var j=v;v=I;try{return Z()}finally{v=j}},o.unstable_scheduleCallback=function(I,Z,j){var Ee=o.unstable_now();switch(typeof j=="object"&&j!==null?(j=j.delay,j=typeof j=="number"&&0<j?Ee+j:Ee):j=Ee,I){case 1:var U=-1;break;case 2:U=250;break;case 5:U=1073741823;break;case 4:U=1e4;break;default:U=5e3}return U=j+U,I={id:g++,callback:Z,priorityLevel:I,startTime:j,expirationTime:U,sortIndex:-1},j>Ee?(I.sortIndex=j,e(p,I),n(d)===null&&I===n(p)&&(T?(O(B),B=-1):T=!0,de(F,j-Ee))):(I.sortIndex=U,e(d,I),E||y||(E=!0,H||(H=!0,le()))),I},o.unstable_shouldYield=w,o.unstable_wrapCallback=function(I){var Z=v;return function(){var j=v;v=Z;try{return I.apply(this,arguments)}finally{v=j}}}}(Eh)),Eh}var Z_;function gS(){return Z_||(Z_=1,Mh.exports=mS()),Mh.exports}var Th={exports:{}},Un={};/**
 * @license React
...
`)}function H1(o,e){let n;switch(e){case WS:n="Linear";break;case qS:n="Reinhard";break;case jS:n="Cineon";break;case YS:n="ACESFilmic";break;case ZS:n="AgX";break;case QS:n="Neutral";break;case KS:n="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),n="Linear"}return"vec3 "+o+"( vec3 color ) { return "+n+"ToneMapping( color ); }"}const Jc=new Y;function G1(){Et.getLuminanceCoefficients(Jc);const o=Jc.x.toFixed(4),e=Jc.y.toFixed(4),n=Jc.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${o}, ${e}, ${n} );`,"	return dot( weights, rgb );","}"].join(`
