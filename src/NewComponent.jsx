    ...
    return (
        ...
        <div>
            ...
            <div class="global-info-block">
                ...
                <h3>{frenchORenglish?"When I was in college, the":"Au collège, la découverte de"} <span class="highlight-me-yellow">scratch</span> {frenchORenglish?"discovery was the bigest thing that made my life change":"fut la naissance de cette"} <span class="highlight-me-blue">{frenchORenglish?"complitly":"passion"}</span>{frenchORenglish?" ":"pour l'informatique"}!</h3>
